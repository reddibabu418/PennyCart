...
<body
	...
	<form action="PennyMartLogin" method="GET" style="text-align: center;">
		<table style="margin-left: 40%; margin-right: 0%;">
			...
			<tr style="text-align: left; color: #DA621E;">
				<td></td>
				<td><center><input type="submit" name="submit" value="Login" class="btn btn-primary"></center>
			</tr>
	...
	<center><input type="submit" value="New User? Register Here" class="btn btn-secondary"></center>
	</form>
	</div>
